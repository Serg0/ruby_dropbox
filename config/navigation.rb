...
=end
  ...
  navigation.items do |primary|
    ...
    primary.item :files, "FILES" do |secondary|
      secondary.item :in_, "INCOMING FILES #{current_user.incoming_files.count}", incoming_path
      secondary.item :out, "OUTGOING FILES #{current_user.outcoming_files.count}", outcoming_path
    end
